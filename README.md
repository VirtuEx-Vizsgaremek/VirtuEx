...
| ---------- | ------------- | -------------------------------------------------------------------------------------- |
| id         | bigint        | Snowflake ID identifying the currency. Generated by the application, not the database. |
...
| field       | type        | explanation                                       |
| ----------- | ----------- | ------------------------------------------------- |
| currency_id | bigint      | Snowflake ID of the related currency.             |
| timestamp   | timestamptz | Point in time for this price entry.               |
...
| field      | type        | explanation                          |
| ---------- | ----------- | ------------------------------------ |
| id         | bigint      | Snowflake ID identifying the wallet. |
...
| field      | type         | explanation                                  |
| ---------- | ------------ | -------------------------------------------- |
| id         | bigint       | Snowflake ID identifying the code entry.     |
| code       | varchar(255) | Verification or reset code sent to the user. |
| type       | code_type    | Purpose of the code.                         |
| user_id    | bigint       | Snowflake ID of the related user.            |
...
| field       | type        | explanation                             |
| ----------- | ----------- | --------------------------------------- |
| id          | bigint      | Snowflake ID identifying the asset.     |
| created_at  | timestamptz | When the asset entry was created.       |
| updated_at  | timestamptz | When the asset entry was last updated.  |
| wallet_id   | bigint      | Snowflake ID of the owning wallet.      |
| currency_id | bigint      | Snowflake ID of the currency.           |
